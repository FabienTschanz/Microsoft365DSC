    ...
    InModuleScope -ModuleName $Global:DscHelper.ModuleName -ScriptBlock {
        ...
        Context -Name "The IntuneMobileAppsBuiltInStoreApp should exist but it DOES NOT" -Fixture {
            ...
            It 'Should return Values from the Get method' {
                ((New-M365DSCResourceInstance -ResourceName 'IntuneMobileAppsBuiltInStoreApp' -Property $testParams).Get().ToHashtable()).Ensure | Should -Be 'Absent'
            }
            It 'Should return false from the Test method' {
                (New-M365DSCResourceInstance -ResourceName 'IntuneMobileAppsBuiltInStoreApp' -Property $testParams).Test() | Should -Be $false
            }
            It 'Should Create the group from the Set method' {
                (New-M365DSCResourceInstance -ResourceName 'IntuneMobileAppsBuiltInStoreApp' -Property $testParams).Set()
        ...
        Context -Name "The IntuneMobileAppsBuiltInStoreApp exists but it SHOULD NOT" -Fixture {
            ...
            It 'Should return Values from the Get method' {
                ((New-M365DSCResourceInstance -ResourceName 'IntuneMobileAppsBuiltInStoreApp' -Property $testParams).Get().ToHashtable()).Ensure | Should -Be 'Present'
            }
        ...
        Context -Name "The IntuneMobileAppsBuiltInStoreApp Exists and Values are already in the desired state" -Fixture {
            ...
            It 'Should return true from the Test method' {
                (New-M365DSCResourceInstance -ResourceName 'IntuneMobileAppsBuiltInStoreApp' -Property $testParams).Test() | Should -Be $true
            }
        }
        ...
        Context -Name 'ReverseDSC Tests' -Fixture {
            ...
            It 'Should Reverse Engineer resource from the Export method' {
                $result = Invoke-M365DSCResourceMethod -ResourceName 'IntuneMobileAppsBuiltInStoreApp' -MethodName 'Export' -Parameters $testParams
