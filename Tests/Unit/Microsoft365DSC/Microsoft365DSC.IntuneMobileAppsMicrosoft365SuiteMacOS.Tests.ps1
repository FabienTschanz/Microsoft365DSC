...
Describe -Name $Global:DscHelper.DescribeHeader -Fixture {
    InModuleScope -ModuleName $Global:DscHelper.ModuleName -ScriptBlock {
        ...
        Context -Name "The IntuneMobileAppsMicrosoft365SuiteMacOS should exist but it DOES NOT" -Fixture {
            BeforeAll {
                $testParams = @{
                    Assignments = @(([MSFT_DeviceManagementMobileAppAssignment] @{
                        groupId = "26d60dd1-fab6-47bf-8656-358194c1a49d"
                        DeviceAndAppManagementAssignmentFilterType = "none"
            ...
            It 'Should return Values from the Get method' {
                ((New-M365DSCResourceInstance -ResourceName 'IntuneMobileAppsMicrosoft365SuiteMacOS' -Property $testParams).Get().ToHashtable()).Ensure | Should -Be 'Absent'
            }
            It 'Should return false from the Test method' {
                (New-M365DSCResourceInstance -ResourceName 'IntuneMobileAppsMicrosoft365SuiteMacOS' -Property $testParams).Test() | Should -Be $false
            }
            It 'Should Create the group from the Set method' {
                (New-M365DSCResourceInstance -ResourceName 'IntuneMobileAppsMicrosoft365SuiteMacOS' -Property $testParams).Set()
        ...
        Context -Name "The IntuneMobileAppsMicrosoft365SuiteMacOS exists but it SHOULD NOT" -Fixture {
            ...
            It 'Should return Values from the Get method' {
                ((New-M365DSCResourceInstance -ResourceName 'IntuneMobileAppsMicrosoft365SuiteMacOS' -Property $testParams).Get().ToHashtable()).Ensure | Should -Be 'Present'
            }
        ...
        Context -Name "The IntuneMobileAppsMicrosoft365SuiteMacOS Exists and Values are already in the desired state" -Fixture {
            ...
            It 'Should return true from the Test method' {
                (New-M365DSCResourceInstance -ResourceName 'IntuneMobileAppsMicrosoft365SuiteMacOS' -Property $testParams).Test() | Should -Be $true
            }
        }
        ...
        Context -Name 'ReverseDSC Tests' -Fixture {
            ...
            It 'Should Reverse Engineer resource from the Export method' {
                $result = Invoke-M365DSCResourceMethod -ResourceName 'IntuneMobileAppsMicrosoft365SuiteMacOS' -MethodName 'Export' -Parameters $testParams
