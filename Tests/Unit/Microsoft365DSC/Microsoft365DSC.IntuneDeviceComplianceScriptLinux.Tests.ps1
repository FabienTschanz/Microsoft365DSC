...
echo false'
            ...
            It 'Should return Values from the Get method' {
                ((New-M365DSCResourceInstance -ResourceName 'IntuneDeviceComplianceScriptLinux' -Property $testParams).Get().ToHashtable()).Ensure | Should -Be 'Absent'
            }
            It 'Should return false from the Test method' {
                (New-M365DSCResourceInstance -ResourceName 'IntuneDeviceComplianceScriptLinux' -Property $testParams).Test() | Should -Be $false
            }
...
echo false'
            ...
            It 'Should return Values from the Get method' {
                ((New-M365DSCResourceInstance -ResourceName 'IntuneDeviceComplianceScriptLinux' -Property $testParams).Get().ToHashtable()).Ensure | Should -Be 'Present'
            }
...
echo false'
            ...
            It 'Should return true from the Test method' {
                (New-M365DSCResourceInstance -ResourceName 'IntuneDeviceComplianceScriptLinux' -Property $testParams).Test() | Should -Be $true
            }
        }
...
echo true'
        ...
        Context -Name 'ReverseDSC Tests' -Fixture {
            ...
            It 'Should Reverse Engineer resource from the Export method' {
                $result = Invoke-M365DSCResourceMethod -ResourceName 'IntuneDeviceComplianceScriptLinux' -MethodName 'Export' -Parameters $testParams
