...
class IntuneEpmElevationRulesPolicyWindows10 : M365DSCResourceBase
{
    ...
    [IntuneEpmElevationRulesPolicyWindows10] Get()
    {
        ...
        try
        {
            ...
            $this.Id = $getValue.Id
            Write-Verbose -Message "An Intune Endpoint Privilege Management Elevation Rules Policy for Windows10 with Id {$($this.Id)} and Name {$($this.DisplayName)} was found"
