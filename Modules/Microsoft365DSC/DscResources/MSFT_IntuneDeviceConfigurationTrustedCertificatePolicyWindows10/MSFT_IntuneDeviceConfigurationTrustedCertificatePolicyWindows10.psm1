...
class IntuneDeviceConfigurationTrustedCertificatePolicyWindows10 : M365DSCResourceBase
{
    ...
    [IntuneDeviceConfigurationTrustedCertificatePolicyWindows10] Get()
    {
        ...
        try
        {
            ...
            $this.Id = $getValue.Id
            Write-Verbose -Message "An Intune Device Configuration Trusted Certificate Policy for Windows10 with Id {$($this.Id)} and DisplayName {$($this.DisplayName)} was found."
