...
class IntuneDeviceConfigurationDeliveryOptimizationPolicyWindows10V2 : M365DSCResourceBase
{
    ...
    [IntuneDeviceConfigurationDeliveryOptimizationPolicyWindows10V2] Get()
    {
        ...
        try
        {
            ...
            $this.Id = $getValue.Id
            Write-Verbose -Message "An Intune Device Configuration Delivery Optimization Policy for Windows10 Setting Catalog with Id {$($this.Id)} and Name {$($this.DisplayName)} was found"
