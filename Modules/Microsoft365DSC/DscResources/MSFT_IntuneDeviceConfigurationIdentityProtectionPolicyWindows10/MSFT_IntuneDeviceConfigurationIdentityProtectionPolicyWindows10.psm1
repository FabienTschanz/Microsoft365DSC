...
class IntuneDeviceConfigurationIdentityProtectionPolicyWindows10 : M365DSCResourceBase
{
    ...
    [IntuneDeviceConfigurationIdentityProtectionPolicyWindows10] Get()
    {
        ...
        try
        {
            ...
            $this.Id = $getValue.Id
            Write-Verbose -Message "An Intune Device Configuration Identity Protection Policy for Windows10 with Id {$($this.Id)} and DisplayName {$($this.DisplayName)} was found."
