...
[DscResource()]
class IntuneDeviceEnrollmentScopeConfigurationMam : M365DSCResourceBase
{
    [DscProperty(Key)]
    ...
    [IntuneDeviceEnrollmentScopeConfigurationMam] Get()
    {
        if ($this.RequiresPowerShellCore())
        {
            $remote = [IntuneDeviceEnrollmentScopeConfigurationMam]::new()
