...
Configuration Example
{
    ...
    Node localhost
    {
        EXODynamicDistributionGroup "EXODynamicDistributionGroup-Example"
        {
            ...
            EmailAddresses                       = @("SMTP:dynamicdistributiongroup_1@$TenantId", "smtp:field.sales.marketing@$TenantId")
            ...
            PrimarySmtpAddress                   = "dynamicdistributiongroup_1@$TenantId"
            ...
            WindowsEmailAddress                  = "dynamicdistributiongroup_1@$TenantId"
            Ensure                               = "Present"
